...
<section class="investment-area">
    <div class="investment">
        <div class="investment-img">
            ...
            <div class="inves-icon">
                <a href="<?php echo $link; ?>">
                    <?php echo wp_get_attachment_image($logoLg, 'full', false, array('class' => 'logo-investment', 'alt' => $name)); ?>
                </a>
            </div><!-- /.inves-icon -->
            <?php endif; ?>
        </div><!-- /.investment-img -->
        <div class="investment-text">
            ...
            <div class="moja">
                <a href="<?php echo $link; ?>">
                    <?php echo wp_get_attachment_image($logoSm, 'full', false, array('class' => 'logo-investment-sm', 'alt' => $name)); ?>
                </a>
            </div><!-- /.moja -->
            <?php endif; ?>
            <div>
