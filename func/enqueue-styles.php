...
function enqueue_styles()
{
    ...
    if (is_post_type_archive('lokale')) {
        ...
        wp_enqueue_style('data-table', 'https://cdn.datatables.net/2.0.3/css/dataTables.dataTables.min.css', ['table'], null);
        wp_enqueue_style('data-table-fixed', 'https://cdn.datatables.net/fixedheader/4.0.1/css/fixedHeader.dataTables.min.css', ['table'], null);
    }
}
